...
def dijkstra(starter_node_name, map, all_nodes, light_status_is_normal):
...
if __name__ == "__main__":
    with open(r"taskTwo.json") as json_data:
    ...
    dijkstra(starter_node_name, map, all_nodes, light_status_is_normal)
